...
class EditRecipeFrameScreen extends StatelessWidget {
  EditRecipeFrameScreen({Key? key}) : super(key: key);
  ...
  Widget _buildInstructionTex(BuildContext context) {
    return Padding(
      ...
      child: CustomTextFormField(
        ...
        hintText: "Add cream of tartar to the egg whites and beat.",
  ...
  Widget _buildInstructionText(BuildContext context) {
    return Padding(
      ...
      child: CustomTextFormField(
        width: 224.h,
        controller: instructionTexController,
        hintText: "Add sugar and beat until stiff glossy peaks form.",
        textInputAction: TextInputAction.done,
        maxLines: 4,
        contentPadding: EdgeInsets.symmetric(
          horizontal: 15.h,
