...
class EditRecipesFrameScreen extends StatefulWidget {
  EditRecipesFrameScreen({Key? key}) : super(key: key);

  @override
  _EditRecipesFrameScreenState createState() => _EditRecipesFrameScreenState();
}

class _EditRecipesFrameScreenState extends State<EditRecipesFrameScreen> {
  ...
  PreferredSizeWidget _buildAppBar(BuildContext context) {
    return CustomAppBar(
      ...
      actions: [
      Padding(
        padding: EdgeInsets.only(right: 15.h), // Adjust the right padding as needed
        child: IconButton(
          icon: Icon(Icons.add, color: Colors.white, size: 40, semanticLabel: 'Add',),
          onPressed: () {
  ...
  return Container(
    ...
    child: Row(
      ...
      children: [
        Stack( // Wrap the recipe component and the CustomImageView in a Stack
          alignment: Alignment.bottomRight, // Align items to the bottom right corner
          children: [
            GestureDetector(
              onTap: () {
            ...
            CustomImageView( // Place the CustomImageView inside the Stack
