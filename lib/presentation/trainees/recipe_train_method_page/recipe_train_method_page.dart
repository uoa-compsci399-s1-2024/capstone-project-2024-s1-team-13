...
class RecipeTrainMethodPage extends StatelessWidget {
  const RecipeTrainMethodPage({Key? key}) : super(key: key);
  ...
  PreferredSizeWidget _buildAppBar(BuildContext context) {
    return CustomAppBar(
      ...
      leading: IconButton(
        ...
        onPressed: () {
          Navigator.pushNamed(context, AppRoutes.recipesScreen); // Navigate to the recipeTrainMethodPage
        },
      ),
      centerTitle: true,
      title: AppbarTitle(
        text: "Recipe Train Method",
      ),
