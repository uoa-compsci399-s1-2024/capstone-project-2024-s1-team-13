...
class NotificationsScreenSupport extends StatelessWidget {
  const NotificationsScreenSupport({Key? key})
      : super(
          key: key,
        );
  ...
  PreferredSizeWidget _buildAppBar(BuildContext context) {
    return CustomAppBar(
      ...
      onPressed: () {
        Navigator.pushNamed(context, AppRoutes.frameOneScreen); // Navigate to the recipeTrainMethodPage
      },
      ),
