...
import 'package:natania_s_application2/widgets/custom_floating_button.dart';
import 'package:dotted_border/dotted_border.dart';
import 'package:flutter/material.dart';
import 'package:natania_s_application2/core/app_export.dart';

class AdminAddTaskNoThreeScreen extends StatelessWidget {
  AdminAddTaskNoThreeScreen({Key? key})
      : super(
          key: key,
        );
  ...
  Widget _buildEnterinstruction(BuildContext context) {
    return Expanded(
      child: CustomTextFormField(
        ...
        borderDecoration: TextFormFieldStyleHelper.fillGrayTL34,
      ),
    );
  }
